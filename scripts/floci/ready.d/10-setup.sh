...
awslocal sqs create-queue --queue-name trade_imports_tracesched_upserted_queue --attributes '{"RedrivePolicy":"{\"deadLetterTargetArn\":\"arn:aws:sqs:eu-west-2:000000000000:trade_imports_tracesched_upserted_queue-deadletter\",\"maxReceiveCount\":\"1\"}"}'
...
awslocal sqs create-queue --queue-name trade_imports_data_upserted_btms_gateway --attributes '{"RedrivePolicy":"{\"deadLetterTargetArn\":\"arn:aws:sqs:eu-west-2:000000000000:trade_imports_data_upserted_btms_gateway-deadletter\",\"maxReceiveCount\":\"1\"}"}'
...
awslocal sqs create-queue --queue-name trade_imports_data_upserted_decision_deriver --attributes '{"RedrivePolicy":"{\"deadLetterTargetArn\":\"arn:aws:sqs:eu-west-2:000000000000:trade_imports_data_upserted_decision_deriver-deadletter\",\"maxReceiveCount\":\"1\"}"}'
...
awslocal sqs create-queue --queue-name trade_imports_inbound_customs_declarations_processor.fifo --attributes '{"FifoQueue":"true","RedrivePolicy":"{\"deadLetterTargetArn\":\"arn:aws:sqs:eu-west-2:000000000000:trade_imports_inbound_customs_declarations_processor-deadletter.fifo\",\"maxReceiveCount\":\"1\"}"}'
...
awslocal sqs create-queue --queue-name trade_imports_data_upserted_processor --attributes '{"RedrivePolicy":"{\"deadLetterTargetArn\":\"arn:aws:sqs:eu-west-2:000000000000:trade_imports_data_upserted_processor-deadletter\",\"maxReceiveCount\":\"1\"}"}'
...
awslocal sqs create-queue --queue-name trade_imports_data_upserted_reporting_api --attributes '{"RedrivePolicy":"{\"deadLetterTargetArn\":\"arn:aws:sqs:eu-west-2:000000000000:trade_imports_data_upserted_reporting_api-deadletter\",\"maxReceiveCount\":\"1\"}"}'
...
awslocal sqs create-queue --queue-name trade_imports_btms_activity_reporting_api --attributes '{"RedrivePolicy":"{\"deadLetterTargetArn\":\"arn:aws:sqs:eu-west-2:000000000000:trade_imports_btms_activity_reporting_api-deadletter\",\"maxReceiveCount\":\"1\"}"}'
